...
if (!prompt) {
  ...
  console.error('Usage: pnpm run test:remote:completions "<prompt text>"');
  process.exit(1);
}

const url = `${REMOTE_URL}/v1/chat/completions`;
...
console.log(`Testing remote completions at: ${url}`);
...
try {
  ...
  console.log('✅ Successfully received response from remote server!');
  console.log('');
